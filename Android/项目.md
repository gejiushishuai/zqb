 ...
 * [rogerou/Baby](https://github.com/rogerou/Baby) -一个私密社交APP,采用Dagger2+Rxjava+LeanCloud+环信+MVP+Tinker进行开发。
 ...
 * [git-xuhao/KotlinMvp](https://github.com/git-xuhao/KotlinMvp) -一款 kotlin 新闻客户端, MVP + RxJava + Retrofit + Dagger2
 
 ### Flutter--Dart
 * [hekaiyou/talk_casually](https://github.com/hekaiyou/talk_casually) -使用Flutter框架和Firebase平台开发的实时聊天APP
 * [konifar/droidkaigi2018-flutter](https://github.com/konifar/droidkaigi2018-flutter) -基于Kotlin+MVP+Retrofit+RxJava+Glide 等架构实现的短视频类的APP
